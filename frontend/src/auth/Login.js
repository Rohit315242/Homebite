  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.wrapper}>
        ...
        {/* Left side — branding */}
        <div style={s.left}>
          <div style={s.tagline}>Welcome back to</div>
          <div style={s.brand}>
            <span style={s.brandGreen}>Home</span>
            <span style={s.brandRed}>Bite</span>
          </div>
          <p style={s.brandDesc}>
            Smart Mess Management — find meals, track attendance, and manage your mess effortlessly.
          </p>
          <div style={s.features}>
            <div style={s.featureItem}>🍽 Explore daily menus</div>
            <div style={s.featureItem}>📍 Find nearby messes</div>
            <div style={s.featureItem}>💳 Secure payments</div>
        ...
        <div style={s.card}>
          ...
          <p style={s.subtitle}>Choose your role and login</p>
          ...
          <button style={s.button} onClick={login}>
            Login →
          </button>

          <p style={s.registerHint}>
            Don't have an account?{" "}
            <a href="/register" style={s.registerLink}>Register</a>
          </p>
        </div>
